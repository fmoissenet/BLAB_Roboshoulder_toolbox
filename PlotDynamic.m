...
for t = 1:n
    ...
    vertices = [Bone(4).(type)(itrial).Object(1).patch.vertices_t(1,:,t); ...
                -Bone(4).(type)(itrial).Object(1).patch.vertices_t(3,:,t); ...
                Bone(4).(type)(itrial).Object(1).patch.vertices_t(2,:,t)];
    patch_array3(Bone(4).(type)(itrial).Object(1).patch.faces, ...
                 vertices,...
